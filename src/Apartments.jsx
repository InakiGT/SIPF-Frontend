...
function Apartments() {
    ...
    const api = new Api('http://localhost:5024/api/Producto/ObtenerDepartamento');
    ...
    return (
        <div class={ styles.productsBg }>
            ...
            <div class={ styles.productsButtons }>
                ...
                <button class={ styles.mainButton }><A href='../new-apartment'>Nuevo</A></button>
            </div>
            ...
            <div class={` ${ styles.simpleCard } ${ styles.productsCard } `}>
                ...
                <Show when={ currentBrands() } fallback={ <Loader /> }>
                    ...
                    <For each={ currentBrands() } >
                        {
                        (brand) => 
                        <div class={ styles.productsProduct } onClick={ () => navigate(`/apartment?id=${ brand.id }`) }>
                            <div>
